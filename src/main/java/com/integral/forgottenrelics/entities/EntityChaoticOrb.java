...
public class EntityChaoticOrb extends EntityThrowable implements IEntityAdditionalSpawnData
{
    ...
    public void onUpdate() {
        ...
        if (this.worldObj.isRemote) {
            for (int a = 0; a < 6; ++a) {
                Thaumcraft.proxy.wispFX4(this.worldObj, (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.2f), (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.2f), (double)((this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.2f), (Entity)this, a, true, 0.0f);
            }
        ...
        if (this.ticksExisted > 20) {
            if (!this.seeker) {
                ...
                final List<Entity> l = (List<Entity>)EntityUtils.getEntitiesInRange(this.worldObj, this.posX, this.posY, this.posZ, (Entity)this, (Class)EntityLivingBase.class, 16.0);
    ...
    protected void onImpact(final MovingObjectPosition mop) {
        ...
        if (!this.worldObj.isRemote) {
            ...
            float expl = 2.0f;
            if (mop.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.isInsideOfMaterial(Material.portal)) {
                expl = 4.0f;
                specialchance = 10.0f;
            }
