...
/**
 * A direct copy of ItemBauble class from Botania.
 * @author Integral
 */

@Optional.Interface(modid = "Thaumcraft", iface = "thaumcraft.api.IRunicArmor")
public abstract class ItemBaubleBase extends Item implements IBauble, ICosmeticAttachable, IPhantomInkable, IRunicArmor {
