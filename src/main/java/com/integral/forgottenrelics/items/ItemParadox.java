...
public class ItemParadox extends ItemSword implements IRepairable, IWarpingGear
{
    ...
    public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity) {
	 ...
	 public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4)
	 {
		 ...
		 par3List.add(StatCollector.translateToLocal("item.ItemParadoxDamage_1.lore") + (int) RelicsConfigHandler.paradoxDamageCap + StatCollector.translateToLocal("item.ItemParadoxDamage_2.lore"));
	 }
