...
public class ClientProxy extends CommonProxy {
	...
	public void registerDisplayInformation() {
		RenderingRegistry.registerEntityRenderingHandler((Class)EntityRageousMissile.class, (Render)new RenderPrimalOrb());
		RenderingRegistry.registerEntityRenderingHandler((Class)EntityChaoticOrb.class, (Render)new RenderPrimalOrb());
	...
	public void lightning(World world, double sx, double sy, double sz, double ex, double ey, double ez, int dur, float curve, int speed, int type, float width) {
	 ...
	 public void wispFX4(final World worldObj, final double posX, final double posY, final double posZ, final Entity target, final int type, final boolean shrink, final float gravity) {
